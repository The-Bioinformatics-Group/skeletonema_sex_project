...
wait 
Trinity --seqType fq --max_memory 240G --SS_lib_type FR --left ${LOC_PAIR}/1F_sorted+singletons.fq,${LOC_PAIR}/2F_sorted+singletons.fq --right ${LOC_PAIR}/1R_sorted+singletons.fq,${LOC_PAIR}/2R_sorted+singletons.fq --CPU 24 --bflyHeapSpaceInit 10G --bflyHeapSpaceMax 12G --bflyCalculateCPU --output /nobackup/data5/skeletonema_sex_project/test/assembly-test/paired_end_sorted+readnorm_trinity --normalize_max_read_cov 40
wait
