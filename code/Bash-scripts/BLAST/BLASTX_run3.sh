...
wait
$blastx -query $TRANSCRIPTOME/skeletonema-marinoi_transcriptome_unannotated.fasta -db $DBLOC2 -outfmt 7  -max_target_seqs 5 -matrix BLOSUM62 -evalue 0.01 -gapopen 11 -gapextend 1 -word_size 6 -out $OUTPUT/blastresults_outfmt7_transcriptomevsphaeoda.txt -num_threads 10
wait
