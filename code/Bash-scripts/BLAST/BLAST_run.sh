...
wait
tblastn -query $ANALYSISLOC/meiosis_athal+scerv.fa -subject $TRANSCRIPTOME -matrix BLOSUM62 -evalue 0.1 -gapopen 11 -gapextend 1 -word_size 6 -out $ANALYSISLOC/blastresults.txt -max_target_seqs 20
wait
