...
wait
tblastn -query $ANALYSISLOC/meiosis_athal+scerv.fa -db skeletonema-marinoi_transcriptome_blastdb/skeletonema-marinoi_transcriptome_unannotated.fasta -outfmt 6 -matrix BLOSUM62 -evalue 0.1 -gapopen 11 -gapextend 1 -word_size 6 -out $ANALYSISLOC/blastresults_outfmt6.txt -num_threads 10 
wait
