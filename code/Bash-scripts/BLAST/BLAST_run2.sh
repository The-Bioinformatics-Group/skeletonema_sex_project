...
#$ -cwd
#$ -q node0
#$ -o /state/partition6/mathias_temp/stdout_BLASTx_annotation_thal7.txt
#$ -e /state/partition6/mathias_temp/stderr_BLASTx_annotation_thal7.txt
#$ -j y
#$ -S /bin/bash
wait
...
wait
blastx -query $TRANSCRIPTOME -db $DBLOC1 -outfmt 7 -max_target_seqs 5 -matrix BLOSUM62 -evalue 0.01 -gapopen 11 -gapextend 1 -word_size 6 -out $OUTPUT/blastresults_outfmt7_transcriptomevsthal.txt -num_threads 10
wait
