...
wait
ls /nobackup/data5/skeletonema_sex_project/test/data-test/rna-sex/cutadapts_results > /nobackup/data5/skeletonema_sex_project/test/temporary_files/ls-output.txt
wait
...
wait
RNASEQFILE=$(sed "${NUM}q;d" /nobackup/data5/skeletonema_sex_project/test/temporary_files/ls-output.txt)
wait
echo "Name: $RNASEQFILE "
wait
fastq_quality_filter -Q33 -q 20 -p 95 -i /nobackup/data5/skeletonema_sex_project/test/data-test/rna-sex/cutadapts_results/$RNASEQFILE/${RNASEQFILE}_adaptrim.fq -o /nobackup/data5/skeletonema_sex_project/test/data-test/rna-sex/fastq_quality_filter_results/${RNASEQFILE}_fastq-q-filt.fq
wait
